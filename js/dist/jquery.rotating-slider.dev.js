    ...
    var rotatingSlider = {
      init: function init(el) {
        ...
        this.settings = $.extend({
          ...
          /* Callback Functions */
          beforeRotationStart: function beforeRotationStart() {},
          afterRotationStart: function afterRotationStart() {},
          beforeRotationEnd: function beforeRotationEnd() {},
          afterRotationEnd: function afterRotationEnd() {}
        }, options);
      ...
      handleDragMove: function handleDragMove(e) {
        if (this.readyToDrag) {
          ...
          if (this.currentlyDragging === false && this.currentlyRotating === false && (this.dragStartPoint - pageX > 10 || this.dragStartPoint - pageX < -10)) {
            this.stopAutoRotate();
      ...
      handleLeftDirectionClick: function handleLeftDirectionClick(e) {
        e.preventDefault();
        this.stopAutoRotate();
        this.rotateClockwise();
      },
      handleRightDirectionClick: function handleRightDirectionClick(e) {
        e.preventDefault();
        this.stopAutoRotate();
      ...
      validateMarkup: function validateMarkup() {
